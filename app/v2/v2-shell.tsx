...
export const SECTIONS: { id: SectionId; label: string; icon: React.ReactNode }[] = [
  ...
  { id: "builds", label: "Live System", icon: <path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /> },
  { id: "screens", label: "Real Result", icon: <path d="M3 4h18v12H3zM8 20h8M12 16v4" /> },
  ...
  { id: "about", label: "About me", icon: <path d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM4 21a8 8 0 0 1 16 0" /> },
