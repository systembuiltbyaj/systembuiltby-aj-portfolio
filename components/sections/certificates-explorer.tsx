...
const techStack: Tool[] = [
  {
    ...
    badges: [
      ...
      { src: "/badges/ghl/ai-tech-stack.webp", label: "Skills Badge — AI Tech Stack" },
      { src: "/badges/ghl/funnel-builder.webp", label: "Skills Badge — Funnel Builder" },
      { src: "/badges/ghl/course-creator.webp", label: "Skills Badge — Course Creator" },
      { src: "/badges/ghl/calendars.webp", label: "Skills Badge — HighLevel Calendars" },
      { src: "/badges/ghl/lead-capture.webp", label: "Skills Badge — Lead Capture Systems" },
      { src: "/badges/ghl/social-media-manager.webp", label: "Skills Badge — Social Media Manager" },
      { src: "/badges/ghl-directory-profile.webp", label: "HighLevel Directory — Public Profile" },
