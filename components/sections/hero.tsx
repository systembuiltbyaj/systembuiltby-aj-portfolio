            ...
            <div className="flex flex-wrap items-center gap-2.5 lg:justify-end">
              {socials.map((s) => (
                <a
                  ...
                  className={
                    s.accent
                      ? "flex h-11 w-11 items-center justify-center rounded-lg border border-white/20 bg-white/[0.13] transition-all hover:border-white/35 hover:bg-white/[0.20]"
